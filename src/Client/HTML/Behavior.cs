...
namespace Sharpen.Html {
    ...
    public abstract class Behavior : IDisposable {
        ...
        public virtual void Dispose() {
            ...
            string name = (string)Type.GetField(this.GetType(), Application.BehaviorNameKey);
            ...
            Dictionary<string, Behavior> behaviors = (Dictionary<string, Behavior>)Type.GetField(_element, Application.BehaviorsKey);
        ...
        public static Behavior GetBehavior(Element element, Type behaviorType) {
            ...
            Dictionary<string, Behavior> behaviors = (Dictionary<string, Behavior>)Type.GetField(element, Application.BehaviorsKey);
            if (behaviors != null) {
        ...
        public virtual void Initialize(Element element, Dictionary<string, object> options) {
            ...
            if (behaviors == null) {
                ...
                Type.SetField(element, Application.BehaviorsKey, behaviors);
            }
